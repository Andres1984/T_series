...
Se calcula para un horizonte de 
...
binomplot(as.numeric(tail(MMM$MMM.Close, n=1)), 0, sd(mmm)*sqrt(5), (1.0231)^(1/52)-1,  4,0, nstep=4, american=TRUE, putopt=TRUE,
