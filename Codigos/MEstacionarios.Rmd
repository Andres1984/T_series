...
acf(fit.arma11@fit$residuals)
acf(fit.ar7@fit$residuals)
acf(fit.ar27@fit$residuals)
...
par(mfrow=c(2,1))
acf( fit.ar2@fit$residuals)
acf(fit.ar6@fit$residuals)
...
```{r}
sum(polyroot(1-fit.ar2@fit$coef))
sum(polyroot(1-fit.ar27@fit$coef))
...
Ahora implementaremos el mismo proceso cuando tenemos un modelo estacional. Antes de comenzar a trabajar la serie, se debe tener claro si esta se encuentra ajustada de forma estacional o desestacionalizada. Cuando se trabaja con una serie estacional ajustada, se ha removido el patrón estacional, no obstante el patrón puede ser muy fuerte y puede encontrarse en la serie creando problemas de varianza.

Siempre que se trabaja con una serie estacionalizada, se van a encontrar dos pasos, primero desetacionalizar la serie y luego encontrar los mejores parámetros del modelo.
